...
CONFIG="configs/vit_adapter/medseg_custom_Lesion.py"
...
do
    ...
    WORK_DIR="work_dirs_Lesion/medseg_custom/fold_${FOLD}"
    ...
    OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 CV_NUM_THREADS=0 python -u train.py $CONFIG \
        --work-dir $WORK_DIR \
        --cfg-options data.train.split="$PWD/data_medical/27919209/MSLesSeg3C/fold/fold_${FOLD}/train.txt" \
                      data.val.split="$PWD/data_medical/27919209/MSLesSeg3C/fold/fold_${FOLD}/val.txt" \

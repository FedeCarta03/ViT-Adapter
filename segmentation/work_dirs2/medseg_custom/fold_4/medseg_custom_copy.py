...
data = dict(
    ...
    train=dict(
        ...
        split=
        '/home/jacopo/Git/ViT-Adapter/segmentation/mslesseg_folds_mstype/fold_4/train.txt',
        img_suffix='.png',
        seg_map_suffix='.png',
    ...
    val=dict(
        ...
        split=
        '/home/jacopo/Git/ViT-Adapter/segmentation/mslesseg_folds_mstype/fold_4/val.txt',
        img_suffix='.png',
        seg_map_suffix='.png',
        classes=('background', 'lesion'),
        palette=[[0, 0, 0], [255, 0, 0]]),
...
evaluation = dict(
    ...
    pre_eval=True,
    save_best='mIoU',
    work_dir='work_dirs2/medseg_custom/fold_4')
pretrained = 'pretrained/deit_base_patch16_224-b5f2ef4d.pth'

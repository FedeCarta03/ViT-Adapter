...
data = dict(
    ...
    train=dict(
        ...
        split=
        '/home/jacopo/Git/ViT-Adapter/segmentation/data_medical/27919209/MSLesSeg3C/fold/fold_2/train.txt',
        img_suffix='.png',
        seg_map_suffix='.png',
    ...
    val=dict(
        ...
        split=
        '/home/jacopo/Git/ViT-Adapter/segmentation/data_medical/27919209/MSLesSeg3C/fold/fold_2/val.txt',
        img_suffix='.png',
        seg_map_suffix='.png',
        classes=('background', 'lesion'),
        palette=[[0, 0, 0], [255, 255, 255]]),
...
evaluation = dict(
    ...
    pre_eval=True,
    save_best='mIoU',
    work_dir='work_dirs_Lesion_copy/medseg_custom/fold_2')
pretrained = 'pretrained/deit_base_patch16_224-b5f2ef4d.pth'

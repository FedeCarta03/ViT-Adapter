...
data_root = 'data_medical/WbcMSBench_Merged'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        split=
        '/home/fede/ViT-Adapter/segmentation/data_medical/WbcMSBench_Merged/stratified_folds/fold_5/train.txt',
        img_suffix='.png',
        seg_map_suffix='.png',
    ...
    val=dict(
        ...
        split=
        '/home/fede/ViT-Adapter/segmentation/data_medical/WbcMSBench_Merged/stratified_folds/fold_5/val.txt',
        img_suffix='.png',
        seg_map_suffix='.png',
        classes=('background', 'cytoplasm', 'nucleus'),
        palette=[[0, 0, 0], [0, 255, 0], [255, 0, 0]]),
...
evaluation = dict(
    ...
    pre_eval=True,
    save_best='mIoU',
    work_dir='work_dirs_WBC/medseg_custom/fold_5')
pretrained = 'pretrained/deit_base_patch16_224-b5f2ef4d.pth'
